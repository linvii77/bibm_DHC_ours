...
- `weights/` — Synapse 3-fold + AMOS 5% fold1 best checkpoint（Git LFS）
- `splits/` — 数据划分
- `results/evaluation_res.txt` — Synapse 参考评估（Dice 47.03%）
- `results/amos_5p_fold1_*` — AMOS 5% fold1 评估与摘要（Dice 40.11%）
